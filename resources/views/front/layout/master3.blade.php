...
<head>
    ...
    <!--bootstrap Css-->
     <!-- <link rel="stylesheet" property="stylesheet" href="{{ URL::asset('/css/paymentstyle/paymentmethodstyle-2.css') }}" type="text/css">
...
<body>
   ...
   <footer class="blog-footer">
    ...
    <!-- <footer class="blog-footer" style="margin-top:0px">
        <div class="container-fluid">
            <div class="text-center">
                <a href="{{url('/')}}">
            ...
            <ul class="list-inline">
                @foreach($social as $data)
                <li class="list-inline-item"><a class=" text-xs-center" style="color: #66a3ac;" target="_blank" style="color:#66a3ac;"
                        href="{{$data->link}}">{!! $data->code !!}</a></li>
                @endforeach
            </ul>
            <p>
                <a style="color: #66a3ac;" href="#">{{$general->copyright}}</a>
                <a style="color: #66a3ac;" href="{{route('terms.index')}}">Terms</a> & <a style="color: #66a3ac;" href="{{route('policy.index')}}">Policy</a>
            </p>
        </div>
    </footer> -->
                    ...
                    success:function (data) {
                        ...
                        if(messages.length > 0){
                            $.each(messages, function(key,value) {
                                ...
                                console.log(url);
                                if(read == null){
                                    string +=  ' <a class="dropdown-item" style="background-color:darkgrey;"  href="'+url+'"> '+message+' <span class="pull-right"> '+times+'</span> </a> <hr>'

                                }else{
                                    string +=  ' <a class="dropdown-item"  href="'+url+'"> '+message+' <span class="pull-right"> '+times+'</span> </a> <hr>'
