                    ...
                    <div class="col-md-12 order-md-2 mb-4">
                      <h4 class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="float-right">
                          ...
                          <form class="d-inline" method="POST" action="{{ route('admin.send.requests.reject', [ 'withdraw' => $withdraw->id ]) }}">
                              @csrf
                              <button type="submit" class="btn btn-sm btn-danger">
                                Reject
                              </button>
                          </form>
                          <form class="d-inline" method="POST" action="{{ route('admin.send.requests.confirm', [ 'withdraw' => $withdraw->id ]) }}">
                              @csrf
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
          <form class="form-horizontal" method="post" action="{{route('admin-send-address-update', $withdraw->id)}}" enctype="multipart/form-data">
              @csrf
